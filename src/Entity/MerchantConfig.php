 ...
 * MerchantConfig
 *
 * @ORM\Table(name="merchant_config", indexes={@ORM\Index(name="takeorderby", columns={"takeorderby"}), @ORM\Index(name="mer_level", columns={"mer_level"}), @ORM\Index(name="mer_type", columns={"mer_type"}), @ORM\Index(name="mer_ref", columns={"mer_ref"})})
 * @ORM\Entity
 */
class MerchantConfig
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="mer_level", type="string", length=0, nullable=true, options={"default"="NULL"})
     */
    private $merLevel = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="merchantlogo", type="string", length=255, nullable=true, options={"default"="NULL"})
     */
    private $merchantlogo = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="smsuid", type="string", length=30, nullable=true, options={"default"="NULL"})
     */
    private $smsuid = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="smspwd", type="string", length=30, nullable=true, options={"default"="NULL"})
     */
    private $smspwd = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="smssender", type="string", length=30, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="servicefee", type="decimal", precision=3, scale=2, nullable=true, options={"default"="NULL"})
     */
    private $servicefee = 'NULL';
     ...
     * @var string
     *
     * @ORM\Column(name="let2pay_mid", type="string", length=3, nullable=false)
     */
    private $let2payMid;
     ...
     * @var string|null
     *
     * @ORM\Column(name="merusername", type="string", length=500, nullable=true, options={"default"="NULL"})
     */
    private $merusername = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="merpassword", type="string", length=500, nullable=true, options={"default"="NULL"})
     */
    private $merpassword = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="mer_addr", type="string", length=500, nullable=true, options={"default"="NULL"})
     */
    private $merAddr = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="paymentmethod", type="string", length=100, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="transportmethod", type="string", length=100, nullable=true, options={"default"="NULL"})
     */
    private $transportmethod = 'NULL';
     ...
     * @var string
     *
     * @ORM\Column(name="country_code_authen", type="string", length=1440, nullable=false, options={"default"="NULL"})
     */
    ...
    public function setMinOrderPrice($minOrderPrice): self
    {
    ...
    public function getMinCodOrder()
    {
        return $this->minCodOrder;
    }

    public function setMinCodOrder($minCodOrder): self
    {
    ...
    public function getMinCodFee()
    {
        return $this->minCodFee;
    }

    public function setMinCodFee($minCodFee): self
    {
    ...
    public function setServicefee($servicefee): self
    {
    ...
    public function setStoreFee($storeFee): self
    {
    ...
    public function setPickupFee($pickupFee): self
    {
    ...
    public function setPacketPrice($packetPrice): self
    {
    ...
    public function setPackingFee($packingFee): self
    {
    ...
    public function getMemberTransferFee()
    {
        return $this->memberTransferFee;
    }

    public function setMemberTransferFee($memberTransferFee): self
    {
